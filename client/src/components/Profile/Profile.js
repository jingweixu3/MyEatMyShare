        ...
        <div className="col-3">
              ...
              <div className="d-flex flex-column align-items-center text-center">
                ...
                {foundUser && (
                  <div className="mt-3">
                    ...
                    {foundUser &&
                      userInfo.googleId !== foundUser.googleId &&
                      !follow && (
                        <button
          ...
          <div className="card mt-3">
            ...
            >
              ...
              {foundUser && userInfo.googleId === foundUser.googleId && (
                <a
                  className="nav-link"
              ...
              <a
                className="nav-link"
                id="v-tabs-follower-tab"
                datamdbtoggle="tab"
                href="#v-tabs-follower"
                data-toggle="tab"
                aria-controls="v-tabs-follower"
                aria-selected="false"
        ...
        <div className="col-9">
          <div className="tab-content" id="v-tabs-tabContent">
                  ...
                  <div className="card h-100">
                    <div className="card-body">
                      <h6 className="d-flex align-items-center mb-3">
                        <i className="material-icons text-info mr-2">Post</i>
                      </h6>
            ...
            <div
              ...
              id="v-tabs-follower"
              role="tabpanel"
              aria-labelledby="v-tabs-follower-tab"
            >
              <ShowFollows
                foundUser={foundUser}
                userInfo={userInfo}
